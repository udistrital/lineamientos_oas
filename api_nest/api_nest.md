...
### 1. Generación del API (Uso del CLI) {#1-generación-del-api-uso-del-cli}
...
### 3. Refactorización del proyecto para manejar controlador, modelos y servicios {#3-refactorización-del-proyecto-para-manejar-controlador-modelos-y-servicios}
...
### 5. Generación de swagger y detalle de .drone para despliegue {#5-generación-de-swagger-y-detalle-de-drone-para-despliegue}
