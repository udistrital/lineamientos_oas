...
### 1. Generación del API (Uso del CLI) <a name="generacion-del-api"></a>
...
### 2. Configuración de variables de entorno <a name="configuracion-de-variables-de-entorno"></a>
...
### 3. Refactorización del proyecto para manejar controlador, modelos y servicios <a name="refactorizacion-del-proyecto"></a>
